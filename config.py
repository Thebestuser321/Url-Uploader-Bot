...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7757327657:AAFOLlBHwkxZqxGdv7utpklqkawF2VwAe20")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Restrict_c0ntent_bot") # Bot username without @.
